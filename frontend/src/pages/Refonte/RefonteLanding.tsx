...
import planetPink from "../../assets/images/planet-pink.webp";
import planetYellow from "../../assets/images/planet-yellow.webp";
const RefonteLanding = () => {
  return (
    <div className="bg-landing">
      ...
      <div className="container-fluid z-2 position-relative">
        <HeroSection
          ...
          url="/analyse-refonte-site-web/refonte-form"
